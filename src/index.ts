...
/**
 * Checks if the provided ID is in a Hierarchical Request ID format.
 */
...
/**
 * Checks if the provided ID is overflowed.
 */
...
/**
 * Checks if the provided ID is an Outgoing ID (but not a Root ID).
 */
...
/**
 * Generates an incoming ID based on provided one. If provided ID is invalid
 * generates it from scratch.
 *
 * After receiving a request from another service it's ID should be used to generate a new incoming id.
 */
...
/**
 * Generates an outgoing ID based on provided one. If provided ID is invalid,
 * generates it from scratch.
 *
 * For each request to another service you should generate a new ID using this method.
 */
...
/**
 * Generates an overflowed ID based on provided one. If provided id is invalid,
 * generates it from scratch.
 */
...
/**
 * Extracts root ID from the provided hierarchical request ID.
 * If root ID cannot be extracted (id is invalid) returns null instead.
 */
